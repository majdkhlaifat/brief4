...
if(isset($_POST['submit1'])){
	...
	$query = "UPDATE users SET Name='$name1', Email='$Email1', Password='$Password1', Mobile='$Mobile1', City='$city1', Address='$Address1' , image='$image1', rule=2 WHERE id={$_GET['id2']}";
	...
	if (isset($_POST["submit"])) {
		...
		$sql = "INSERT INTO `users`(`Name`, `Email`, `Password`, `Mobile`, `City`, `Address`,`image`,  `rule`) VALUES ('$name','$Email','$Password','$Mobile','$city','$Address' ,'$image',2)";
		$result = mysqli_query($conn, $sql);
		if ($result) {
			header("Location: admin.php?msg=New User added successfully");
		} else {
    ...
    <div class="user-container">
      ...
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        ...
        <table class="table" >
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM `users` where rule = 1 or rule=2" ;
                $result = mysqli_query($conn, $sql);
                ...
                ?>
                    ...
                    <td><?php echo $row["id"] ?></td>
                        ...
                        <td>
                            <a href="admin.php?id2=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-file-pen  fs-5 me-3"></i></a>
                            <a href="admin.php?id1=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
                <?php
                }
