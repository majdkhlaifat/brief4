...
if(isset($_GET['id1'])){
	...
	$id1 = $_GET["id1"];
	$query = "DELETE FROM products WHERE id  = $id1";
...
if(isset($_POST['submit1'])){
	...
	$query = "UPDATE `products` SET `name`='$name1',`price`='$price1',`details`='$details1',`img`='$image1',`category`='$category1' WHERE id={$_GET['id2']}";
...
;
		...
		$sql = "INSERT INTO `products`( `name`, `price`, `details`, `img`, `category`) VALUES ('$name','$price','$details','$image','$category')";
		$result = mysqli_query($conn, $sql);
		if ($result) {
			header("Location: product.php?msg=New User added successfully");
		} else {
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><?php echo $row["id"] ?></td>
                        ...
                        <td>
                            <a href="product.php?id2=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-file-pen  fs-5 me-3"></i></a>
                            <a href="product.php?id1=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
                <?php
                }
...
?>
                ...
                <form action="" method="POST" class=add-user id=add>
					...
					<input type="text" name="detalils" placeholder="details">
					<select name="category" id="">
						<option value="1">Fruite</option>
				...
				<?php 
					if(isset($_GET['id2'])){
						...
						$sql = "SELECT * FROM `products` WHERE id = '{$_GET['id2']}'";
						$result = mysqli_query($conn, $sql);
			 $row = mysqli_fetch_assoc($result);
                ...
                <form action="" method="POST" class=add-user id=edit>
					...
					<input type="text" name="detalils" placeholder="details" value="<?php echo $row["details"]; ?>">
					<select name="category" id="">
						<option value="1" >Fruite</option>
						<option value="2" >Vegetables</option>
					</select>
